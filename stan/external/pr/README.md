...
| 6 | walnutpie init-protocol guard | walnutpie (fork or upstream) | `robustness/init-guard` (`external/walnutpie_rob` worktree) | `dev/init-robustness` = `3eddfc4` | `pr-6-walnutpie-init-guard.md` | ✓ fork |
